...
export default function Button({
  ...
  return (
    <button
      className={`mt-8 py-4 px-4 xs:px-6 xl:px-8 2xl:px-10 2xl:py-6 border-2 border-${routeStatus.present}-lining text-${routeStatus.present}-lining rounded-lg text-md xs:text-xl font-bold ${classy}`}
